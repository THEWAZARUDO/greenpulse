...
Định dạng tài liệu tuân thủ chuẩn quốc tế [Keep a Changelog](https://keepachangelog.com/vi/1.0.0/) và phân định phiên bản theo [Semantic Versioning](https://semver.org/).

---

## 📑 Mục lục các phiên bản
* [v1.1.0 - 03/09/2026](#110---2026-09-03) *(AutoProvision ESP32 Đa Mạng, Backend Auth-Web & App Icon mới)*
...
### 🏗️ Kiến Trúc & Tái Cấu Trúc (Refactoring & Modularization)
* **Refactor (Phân Tách Module Toàn Diện):** Chia nhỏ các file giao diện khổng lồ (>1000 dòng) thành kiến trúc thư mục con rõ ràng, áp dụng Clean Code và Design System nhất quán:
...
### 🛡️ Cơ Sở Dữ Liệu & Bảo Mật (Database & Security)
...
* **Fixed (Loại Bỏ Vùng Chết - Dead Zones):** Hiệu chỉnh toàn bộ các hàm liên thuộc hình tam giác và hình thang (Triangular & Trapezoidal Membership Functions) của 5 thông số môi trường (Nhiệt độ, Độ ẩm không khí, Độ ẩm đất, Ánh sáng, Độ pH) đảm bảo mức độ giao nhau (Overlap) luôn $\ge 0.5$, triệt tiêu hoàn toàn trường hợp không có luật mờ nào kích hoạt.
...
### 🌤️ Dịch Vụ Thời Tiết Nông Nghiệp Thông Minh (Agri-Weather Engine)
...
* **Added (Local Notifications):** Cấu hình `flutter_local_notifications` hiển thị thông báo biểu tượng chiếc lá trên thanh trạng thái điện thoại ngay cả khi ứng dụng đang chạy nền hoặc đã tắt.
...
### 🚀 Bước Ngoặt Kiến Trúc: Edge AI Cục Bộ (Local Inference)
